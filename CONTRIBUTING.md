...
2. Update the version in `package.json` and `src/index.ts`, README publication status and release notes. Run `bun install` to refresh the lockfile if needed.
